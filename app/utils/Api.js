...
function makeFormDataPostHeaders() {
  console.warn("I am in makePostHeaders()");
  let headerObj = {};
...
function makeGetHeaders() {
  console.warn("I am in makeGetHeaders()");
  let headerObj = {};
  const accessToken =
...
axiosApi.interceptors.request.use((request) => {
  if (request.method === "get") {
    ...
    // if (request.url === "auth/login" || request.url === "forgot-password") {
