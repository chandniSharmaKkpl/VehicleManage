const StaticTitle = {
  ...
  forgotpasserror:
    "Your email address cannot be found or is not valid. Please try again or create an account",
  or: "or",
  ...
  termAndConditionLast:
    "a confirmation email will be sent to the above email to activate your account.",
